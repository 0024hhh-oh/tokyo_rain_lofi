...
- 波形は白系（白〜薄グレー）の横線表示で、透明背景として画面下部中央に重ねます。
...
1. GitHub Actionsが30分ごとに `TokyoChillMatic/incoming` を確認します。
...
3. Google Driveの `TokyoChillMatic/incoming/work_001/` に `background.png` とmp3素材を配置します。
