...
BACKGROUND_FILE=""
for background in "$ASSET_DIR/background.png" "$ASSET_DIR/background.jpg" "$ASSET_DIR/background.jpeg"; do
...
if [[ -z "$BACKGROUND_FILE" ]]; then
  echo "Missing required background: $ASSET_DIR/background.png, $ASSET_DIR/background.jpg, or $ASSET_DIR/background.jpeg" >&2
  exit 1
fi
HAS_RAIN_AUDIO=0
