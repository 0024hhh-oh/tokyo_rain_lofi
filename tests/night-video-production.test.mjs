...
test('production night video uses positive-only glow on eligible emitters', () => {
  ...
  assert.match(component, /outerPadding = isSmallSource \? 1\.25 : 0\.42/);
  assert.match(component, /middlePadding = isSmallSource \? 0\.62 : 0\.28/);
  assert.match(component, /source-outer-/);
  assert.match(component, /source-middle-/);
